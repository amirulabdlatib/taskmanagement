...
public class CompleteTaskAdapter extends RecyclerView.Adapter<CompleteTaskAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        public ViewHolder(View itemView) {
            ...
            taskStaff = (TextView) itemView.findViewById(R.id.staff);
            taskdue = (TextView) itemView.findViewById(R.id.duedate);
    ...
    public CompleteTaskAdapter(Context context, List<Task> listData){
        mListData = listData;
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.activity_new_task_list, parent, false);
