...
import com.example.taskmanagement.adapter.CompleteTaskAdapter;
import com.example.taskmanagement.adapter.TaskAdapter;
import com.example.taskmanagement.adapter.TaskStaffAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskService.getAllTasks(user.getToken()).enqueue(new Callback<List<Task>>() {
            ...
            public void onResponse(Call<List<Task>> call, Response<List<Task>> response) {
                ...
                // initialize adapter
                CompleteTaskAdapter adapter = new CompleteTaskAdapter(context, tasks);
            ...
            public void onFailure(Call<List<Task>> call, Throwable t) {
                Toast.makeText(context, "Error sfdfs to the server", Toast.LENGTH_LONG).show();
    ...
    private void updateListView() {
        ...
        taskService.getAllTasks(user.getToken()).enqueue(new Callback<List<Task>>() {
            ...
            public void onResponse(Call<List<Task>> call, Response<List<Task>> response) {
                ...
                // initialize adapter
                adapter = new CompleteTaskAdapter(context, tasks);
