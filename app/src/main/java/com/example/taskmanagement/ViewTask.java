...
public class ViewTask extends AppCompatActivity {
    ...
    private void updateListView() {
        ...
        taskService.getAllTasks(user.getToken()).enqueue(new Callback<List<Task>>() {
            ...
            public void onResponse(Call<List<Task>> call, Response<List<Task>> response) {
                ...
                // initialize adapter
                adapter = new TaskStaffAdapter(context, tasks);
    ...
    private void doUpdate(Task selectedTask) {
        ...
        // launch UpdateBookActivity and pass the task id
        Intent intent = new Intent(context, UpdateTaskStatus.class);
        intent.putExtra("task_id", selectedTask.getTaskID());
        startActivity(intent);
    }
